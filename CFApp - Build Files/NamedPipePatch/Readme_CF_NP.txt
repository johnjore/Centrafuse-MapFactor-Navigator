...
To install this patch, copy the files in this folder to the PC_Navigator run time folder

This patch will modify the files PC_navigator.exe so these modules referrence to the 
